...
impl Ie {
    ///0x00 - GPIO interrupt enable value
    #[inline(always)]
    pub const fn value(&self) -> &Value {
        &self.value
    }
    ///0x04 - GPIO interrupt enable set
    #[inline(always)]
    pub const fn set(&self) -> &Set {
        &self.set
    }
    ///0x08 - GPIO interrupt enable clear
    #[inline(always)]
    pub const fn clear(&self) -> &Clear {
        &self.clear
    }
    ///0x0c - GPIO interrupt enable toggle
    #[inline(always)]
    pub const fn toggle(&self) -> &Toggle {
        &self.toggle
    }
}
/**VALUE (rw) register accessor: GPIO interrupt enable value
...
pub mod value;
/**SET (rw) register accessor: GPIO interrupt enable set
...
pub mod set;
/**CLEAR (rw) register accessor: GPIO interrupt enable clear
...
pub mod clear;
/**TOGGLE (rw) register accessor: GPIO interrupt enable toggle
