...
impl Oe {
    ///0x00 - GPIO direction value
    #[inline(always)]
    pub const fn value(&self) -> &Value {
        &self.value
    }
    ///0x04 - GPIO direction set
    #[inline(always)]
    pub const fn set(&self) -> &Set {
        &self.set
    }
    ///0x08 - GPIO direction clear
    #[inline(always)]
    pub const fn clear(&self) -> &Clear {
        &self.clear
    }
    ///0x0c - GPIO direction toggle
    #[inline(always)]
    pub const fn toggle(&self) -> &Toggle {
        &self.toggle
    }
}
/**VALUE (rw) register accessor: GPIO direction value
...
pub mod value;
/**SET (rw) register accessor: GPIO direction set
...
///GPIO direction set
pub mod set;
/**CLEAR (rw) register accessor: GPIO direction clear
...
pub mod clear;
/**TOGGLE (rw) register accessor: GPIO direction toggle
