...
impl As {
    ///0x00 - GPIO interrupt asynchronous value
    #[inline(always)]
    pub const fn value(&self) -> &Value {
        &self.value
    }
    ///0x04 - GPIO interrupt asynchronous set
    #[inline(always)]
    ...
    ///0x0c - GPIO interrupt asynchronous toggle
    #[inline(always)]
    pub const fn toggle(&self) -> &Toggle {
        &self.toggle
    }
}
/**VALUE (rw) register accessor: GPIO interrupt asynchronous value
...
pub mod value;
/**SET (rw) register accessor: GPIO interrupt asynchronous set
...
pub mod set;
/**CLEAR (rw) register accessor: GPIO interrupt asynchronous clear
...
pub mod clear;
/**TOGGLE (rw) register accessor: GPIO interrupt asynchronous toggle
