...
impl Retention {
    ///0x00 - Retention Control
    #[inline(always)]
    pub const fn value(&self) -> &Value {
        &self.value
    }
    ///0x04 - Retention Control
    #[inline(always)]
    pub const fn set(&self) -> &Set {
        &self.set
    }
    ///0x08 - Retention Control
    #[inline(always)]
    pub const fn clear(&self) -> &Clear {
        &self.clear
    }
    ///0x0c - Retention Control
    #[inline(always)]
    pub const fn toggle(&self) -> &Toggle {
        &self.toggle
    }
}
/**VALUE (rw) register accessor: Retention Control
...
///Retention Control
pub mod value;
/**SET (rw) register accessor: Retention Control
...
///Retention Control
pub mod set;
/**CLEAR (rw) register accessor: Retention Control
...
///Retention Control
pub mod clear;
/**TOGGLE (rw) register accessor: Retention Control
