///Register `DACCLK[%s]` reader
pub type R = crate::R<DacclkSpec>;
///Register `DACCLK[%s]` writer
pub type W = crate::W<DacclkSpec>;
...
impl W {
    ///Bit 8 - current mux 0: ahb0 clock 1: ana clock N
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<'_, DacclkSpec> {
        MuxW::new(self, 8)
    }
    ///Bit 28 - preserve function against global select 0: select global clock setting 1: not select global clock setting
    #[inline(always)]
    pub fn preserve(&mut self) -> PreserveW<'_, DacclkSpec> {
        PreserveW::new(self, 28)
    }
}
/**no description available

You can [`read`](crate::Reg::read) this register and get [`dacclk::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dacclk::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct DacclkSpec;
impl crate::RegisterSpec for DacclkSpec {
    type Ux = u32;
}
///`read()` method returns [`dacclk::R`](R) reader structure
impl crate::Readable for DacclkSpec {}
///`write(|w| ..)` method takes [`dacclk::W`](W) writer structure
impl crate::Writable for DacclkSpec {
    type Safety = crate::Unsafe;
}
///`reset()` method sets DACCLK[%s] to value 0
impl crate::Resettable for DacclkSpec {}
